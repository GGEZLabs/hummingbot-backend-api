...
class V2ScriptDeployment(BaseModel):
    ...
    account_config: Optional[str] = Field(default="default", description="Name of the account config folder")
    ...
    script_config: Optional[str] = Field(
        default=None, description="Name of the script configuration file (without .yml extension)"
    )
